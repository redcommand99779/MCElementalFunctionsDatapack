...
execute as @a[scores= {ElementalGuide=1}] run function mce:npc/guide/mceguide1
execute as @s[scores={ElementalGuide=1}] run scoreboard players set @s ElementalGuide 0